<x-app-layout>
    @php $header = 'Tambah Siswa'; @endphp
            ...
            <div class="card" style="margin-bottom:20px">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" id="nama" value="{{ old('nama') }}" class="form-control" placeholder="Masukkan nama lengkap siswa" required>
                ...
                <div class="card-body">
                    <div class="form-group" style="margin-bottom:0">
                        ...
                        <select name="jurusan" id="jurusan" class="form-control" required>
                            ...
                            <option value="PPLG 1" {{ old('jurusan') == 'PPLG 1' ? 'selected' : '' }}>Pengembangan Perangkat Lunak dan Gim (PPLG 1)</option>
                            <option value="PPLG 2" {{ old('jurusan') == 'PPLG 2' ? 'selected' : '' }}>Pengembangan Perangkat Lunak dan Gim (PPLG 2)</option>
                            <option value="DKV 1" {{ old('jurusan') == 'DKV 1' ? 'selected' : '' }}>Desain Komunikasi Visual (DKV 1)</option>
                            <option value="DKV 2" {{ old('jurusan') == 'DKV 2' ? 'selected' : '' }}>Desain Komunikasi Visual (DKV 2)</option>
                            <option value="BD 1" {{ old('jurusan') == 'BD 1' ? 'selected' : '' }}>Bisnis Digital (BD 1)</option>
                            <option value="BD 2" {{ old('jurusan') == 'BD 2' ? 'selected' : '' }}>Bisnis Digital (BD 2)</option>
                            <option value="TJKT 1" {{ old('jurusan') == 'TJKT 1' ? 'selected' : '' }}>Teknik Jaringan Komputer dan Telekomunikasi (TJKT 1)</option>
                            <option value="TJKT 2" {{ old('jurusan') == 'TJKT 2' ? 'selected' : '' }}>Teknik Jaringan Komputer dan Telekomunikasi (TJKT 2)</option>
                        </select>
