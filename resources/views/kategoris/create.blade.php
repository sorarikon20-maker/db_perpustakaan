<x-app-layout>
    @php $header = 'Tambah Kategori'; @endphp
            ...
            <div class="card" style="margin-bottom:20px">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_kategori" id="nama_kategori" value="{{ old('nama_kategori') }}" class="form-control" placeholder="Contoh: Fiksi, Non-Fiksi, Sains..." required>
                    ...
                    <div class="form-group" style="margin-bottom:0">
                        ...
                        <textarea name="keterangan" id="keterangan" rows="4" class="form-control" placeholder="Deskripsi singkat tentang kategori ini, misalnya jenis buku apa saja yang termasuk dalam kategori ini...">{{ old('keterangan') }}</textarea>
