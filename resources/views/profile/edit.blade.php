<x-app-layout>
    ...
    <div class="profile-hero">
        <div class="profile-avatar-wrapper">
            ...
            <form method="POST" action="{{ route('profile.photo.update') }}" enctype="multipart/form-data" id="hero-photo-form">
                @csrf
        ...
        <div class="profile-hero-info">
            <h1 class="profile-hero-name">{{ Auth::user()->name ?? 'User' }}</h1>
        ...
        <div class="profile-hero-meta">
            ...
            <div class="profile-meta-item">
                ...
                Terakhir diubah: {{ Auth::user()->updated_at ? Auth::user()->updated_at->diffForHumans() : '-' }}
            </div>
        </div>
    </div>
    ...
    <div class="photo-upload-section">
        ...
        <div class="photo-upload-body">
            <div class="photo-upload-preview">
                @if(Auth::user()->profile_photo)
                    <img src="{{ asset('storage/' . Auth::user()->profile_photo) }}" alt="Foto Profil" id="photo-preview-img">
                @else
                    {{ strtoupper(substr(Auth::user()->name ?? 'U', 0, 2)) }}
                @endif
            </div>
            <div class="photo-upload-info">
                ...
                <div class="photo-upload-actions">
                    ...
                    @if(Auth::user()->profile_photo)
                        <form method="POST" action="{{ route('profile.photo.remove') }}" id="photo-remove-form">
                            @csrf
                            @method('delete')
            ...
            <div class="profile-section-body">
                ...
                <form method="post" action="{{ route('profile.update') }}" id="profile-update-form">
                    ...
                    <div class="profile-form-group">
                        ...
                        <input id="name" name="name" type="text" class="profile-form-input" value="{{ old('name', $user->name) }}" required autofocus autocomplete="name" placeholder="Masukkan nama lengkap...">
                        @if($errors->get('name'))
                    ...
                    <div class="profile-form-group">
                        ...
                        <input id="email" name="email" type="email" class="profile-form-input" value="{{ old('email', $user->email) }}" required autocomplete="username" placeholder="contoh@email.com">
                        @if($errors->get('email'))
