...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Perpustakaan') }} - Admin Panel</title>
        ...
        <aside id="sidebar">
            ...
            <a href="{{ route('dashboard') }}" class="sidebar-logo">
                <div class="sidebar-logo-icon">
                    <img src="{{ asset('/images/logo.jpeg') }}" alt="Logo" style="width: 40px; height: 40px; border-radius: 10px;">
                </div>
            ...
            <nav class="sidebar-nav">
                ...
                <a href="{{ route('siswas.index') }}"
                   class="nav-item {{ request()->routeIs('siswas.*') ? 'active' : '' }}"
                   data-tooltip="Siswa">
                    <span class="nav-icon">
                        <svg fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                ...
                <a href="{{ route('kategoris.index') }}"
                   class="nav-item {{ request()->routeIs('kategoris.*') ? 'active' : '' }}"
                ...
                <a href="{{ route('bukus.index') }}"
                   class="nav-item {{ request()->routeIs('bukus.*') ? 'active' : '' }}"
                   data-tooltip="Buku">
                    <span class="nav-icon">
                        <svg fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                ...
                <a href="{{ route('rak-buku.index') }}"
                   class="nav-item {{ request()->routeIs('rak-buku.*') ? 'active' : '' }}"
                ...
                <a href="{{ route('peminjamans.index') }}"
                   class="nav-item {{ request()->routeIs('peminjamans.index') ? 'active' : '' }}"
                ...
                <a href="{{ route('peminjamans.laporan') }}"
                   class="nav-item {{ request()->routeIs('peminjamans.laporan') ? 'active' : '' }}"
                ...
                <div class="topbar-left">
                    ...
                    @isset($header)
                        <div class="breadcrumb">
                            <a href="{{ route('dashboard') }}" style="color:var(--text-secondary); text-decoration:none;">Home</a>
                            ...
                            <span class="breadcrumb-active">{{ $header }}</span>
                        </div>
                    @endisset
                </div>
