    ...
    <div class="wrapper">
        ...
        <nav class="topnav">
            <a href="<?php echo e(url('/')); ?>" class="nav-logo">
                <div>
                    <img src="<?php echo e(asset('images/logo.jpeg')); ?>" alt="Logo" class="nav-logo-icon">
                </div>
            ...
            <div class="nav-actions">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="nav-btn nav-btn-primary">
                ...
                <?php else: ?>
                    <?php if(Route::has('login')): ?>
                        <a href="<?php echo e(route('login')); ?>" class="nav-btn nav-btn-outline">Masuk</a>
                    <?php endif; ?>
                    <?php if(Route::has('register')): ?>
                        <a href="<?php echo e(route('register')); ?>" class="nav-btn nav-btn-primary">Daftar Gratis</a>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
        </nav>
        ...
        <section class="hero">
            ...
            <div class="hero-actions">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="hero-btn hero-btn-cta">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="hero-btn hero-btn-cta">
            ...
            <div class="stats-bar">
                <div class="stat-item">
                    <div class="stat-item-value"><?php echo e(\App\Models\Siswa::count()); ?>+</div>
                    <div class="stat-item-label">Siswa Terdaftar</div>
                </div>
                <div class="stat-divider"></div>
                <div class="stat-item">
                    <div class="stat-item-value"><?php echo e(\App\Models\Buku::count()); ?>+</div>
                    <div class="stat-item-label">Koleksi Buku</div>
                </div>
                <div class="stat-divider"></div>
                <div class="stat-item">
                    <div class="stat-item-value"><?php echo e(\App\Models\Peminjaman::count()); ?>+</div>
                    <div class="stat-item-label">Transaksi Peminjaman</div>
                </div>
                <div class="stat-divider"></div>
                <div class="stat-item">
                    <div class="stat-item-value"><?php echo e(\App\Models\Kategori::count()); ?>+</div>
        ...
        <section class="section" id="favorite">
            ...
            <div class="favorite-grid">
                <?php $__empty_1 = true; $__currentLoopData = $favoriteBooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $buku): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <article class="favorite-card reveal">
                        <div class="favorite-cover">
                            <img src="<?php echo e($buku->cover_image ? asset('storage/'.$buku->cover_image) : 'https://via.placeholder.com/110x150?text=Cover'); ?>" alt="Cover <?php echo e($buku->judul); ?>">
                        </div>
                        <div class="favorite-meta">
                            <h3><?php echo e($buku->judul); ?></h3>
                            <p><?php echo e($buku->penulis); ?> · <?php echo e($buku->tahun_terbit); ?></p>
                            <span class="favorite-badge">Dipinjam <?php echo e($buku->peminjamans_count); ?>x</span>
                        </div>
                    </article>
        ...
        <footer>
            ...
            <p class="footer-copy">© <?php echo e(date('Y')); ?> Sistem Manajemen Perpustakaan. All rights reserved.</p>

            <div class="footer-links">
                <a href="<?php echo e(route('login')); ?>" class="footer-link">Masuk</a>
                <a href="<?php echo e(route('register')); ?>" class="footer-link">Daftar</a>
                <?php if(auth()->guard()->check()): ?>
...
<?php /**PATH C:\laragon\www\Azzam-sp-XI-PPLG-1-TUGAS-MIGRATION\resources\views/welcome.blade.php ENDPATH**/ ?>