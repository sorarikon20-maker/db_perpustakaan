    ...
    <div>
        ...
        <div style="display:flex;align-items:center;gap:14px;margin-bottom:28px">
            ...
            <div style="flex:1">
                ...
                <p style="font-size:14px;color:#64748b;margin:0">Perbarui data peminjaman <strong style="color:#6366f1">#<?php echo e($peminjaman->id); ?></strong></p>
            </div>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:20px">
            ...
            <div style="background:linear-gradient(135deg,#eef2ff,#e0e7ff);border:1px solid #c7d2fe;border-radius:14px;padding:16px 20px;display:flex;align-items:center;gap:12px">
                ...
                <div>
                    ...
                    <p style="font-size:13px;color:#6366f1;margin:2px 0 0"><?php echo e($peminjaman->user ? $peminjaman->user->name : Auth::user()->name); ?></p>
                </div>
            </div>
            ...
            <?php if($terlambat): ?>
                <div style="background:linear-gradient(135deg,#fef2f2,#fee2e2);border:1px solid #fecaca;border-radius:14px;padding:16px 20px;display:flex;align-items:center;gap:12px">
                    ...
                    <div>
                        ...
                        <p style="font-size:13px;color:#dc2626;margin:2px 0 0;font-weight:600">Denda: Rp <?php echo e(number_format($dendaSekarang, 0, ',', '.')); ?></p>
                    </div>
                </div>
            <?php else: ?>
        ...
        <form method="POST" action="<?php echo e(route('peminjamans.update', $peminjaman)); ?>" id="formPeminjaman">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select name="siswa_id" id="siswa_id" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $siswas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $siswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($siswa->id); ?>" <?php echo e(old('siswa_id', $peminjaman->siswa_id) == $siswa->id ? 'selected' : ''); ?>>
                            ...
                            <select name="buku_id" id="buku_id" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $bukus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $buku): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($buku->id); ?>" 
                                            data-stok="<?php echo e($buku->stok); ?>"
                                            <?php echo e(old('buku_id', $peminjaman->buku_id) == $buku->id ? 'selected' : ''); ?>

                                            <?php echo e($buku->stok <= 0 && $buku->id != $peminjaman->buku_id ? 'style=color:#ef4444' : ''); ?>>
                                        <?php echo e($buku->judul); ?> — <?php echo e($buku->penulis); ?> [Stok: <?php echo e($buku->stok); ?>]
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                ...
                <div class="card-body">
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px">
                        <div class="form-group">
                            ...
                            <input type="date" name="tanggal_pinjam" id="tanggal_pinjam" value="<?php echo e(old('tanggal_pinjam', $peminjaman->tanggal_pinjam)); ?>" class="form-control" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="batas_kembali" id="batas_kembali" value="<?php echo e(old('batas_kembali', $peminjaman->batas_kembali)); ?>" class="form-control" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px">
                        <div class="form-group">
                            ...
                            <input type="date" name="tanggal_kembali" id="tanggal_kembali" value="<?php echo e(old('tanggal_kembali', $peminjaman->tanggal_kembali)); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const currentBukuId = '<?php echo e($peminjaman->buku_id); ?>';
            const currentStatus = '<?php echo e($peminjaman->status); ?>';
...
<?php endif; ?><?php /**PATH C:\laragon\www\Azzam-sp-XI-PPLG-1-TUGAS-MIGRATION\resources\views/peminjamans/edit.blade.php ENDPATH**/ ?>