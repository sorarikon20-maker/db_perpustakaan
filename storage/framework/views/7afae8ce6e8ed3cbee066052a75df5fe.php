...
<?php $component->withAttributes([]); ?>
    ...
    <div class="welcome-banner">
        <div class="welcome-text">
            <h2>Halo, <?php echo e(Auth::user()->name ?? 'Admin'); ?>! 👋</h2>
            <p>Selamat datang di Knowledge Tree. Kelola semua data dengan mudah.</p>
            <div class="welcome-actions">
                <a href="<?php echo e(route('bukus.create')); ?>" class="welcome-btn welcome-btn-primary">
                    <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/>
                    </svg>
                    Tambah Buku
                </a>
                <a href="<?php echo e(route('peminjamans.create')); ?>" class="welcome-btn welcome-btn-outline">
                    <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
    ...
    <div class="stat-cards-grid">
        <a href="<?php echo e(route('siswas.index')); ?>" class="stat-card-new blue">
            ...
            <div class="stat-info">
                ...
                <div class="stat-info-value"><?php echo e(\App\Models\Siswa::count()); ?></div>
        ...
        <a href="<?php echo e(route('kategoris.index')); ?>" class="stat-card-new green">
            ...
            <div class="stat-info">
                ...
                <div class="stat-info-value"><?php echo e(\App\Models\Kategori::count()); ?></div>
        ...
        <a href="<?php echo e(route('bukus.index')); ?>" class="stat-card-new purple">
            ...
            <div class="stat-info">
                ...
                <div class="stat-info-value"><?php echo e(\App\Models\Buku::count()); ?></div>
        ...
        <a href="<?php echo e(route('peminjamans.index')); ?>" class="stat-card-new orange">
            ...
            <div class="stat-info">
                ...
                <div class="stat-info-value"><?php echo e(\App\Models\Peminjaman::count()); ?></div>
    ...
    <div class="info-row" style="margin-bottom:28px;">
        <div class="dashboard-panel" style="background:white;border:1px solid #e2e8f0;border-radius:18px;padding:24px;">
            <div style="display:flex;align-items:center;justify-content:space-between;gap:16px;margin-bottom:18px;flex-wrap:wrap;">
                ...
                <div style="font-size:13px;color:#475569;">Bulan ini: Rp <?php echo e(number_format($monthlyTotals[now()->month] ?? 0, 0, ',', '.')); ?></div>
            </div>
            <div style="background:#f8fafc;border-radius:14px;padding:24px;text-align:center;max-width:300px;margin:auto;">
                <div style="font-size:14px;color:#64748b;margin-bottom:8px;">Total Denda di Bulan <?php echo e(\Carbon\Carbon::now()->translatedFormat('F Y')); ?></div>
                <div style="font-size:32px;font-weight:800;color:#0f172a;">
                    Rp <?php echo e(number_format($monthlyTotals[now()->month] ?? 0, 0, ',', '.')); ?>
        ...
        <div class="dashboard-panel" style="background:white;border:1px solid #e2e8f0;border-radius:18px;padding:24px;">
            <div style="display:flex;align-items:center;justify-content:space-between;gap:16px;flex-wrap:wrap;margin-bottom:18px;">
                ...
                <div style="font-size:13px;color:#475569;">Terlambat saat ini: <?php echo e($activeLateCount); ?> transaksi</div>
            </div>
            <?php if($recentFineHistory->isEmpty()): ?>
                <div style="color:#64748b;font-size:13px;">Tidak ada histori denda terbaru.</div>
            <?php else: ?>
                <div style="display:grid;gap:12px;">
                    <?php $__currentLoopData = $recentFineHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div class="denda-item" style="display:flex;align-items:center;justify-content:space-between;gap:12px;border:1px solid #e2e8f0;border-radius:14px;padding:14px;">
                            <div>
                                <div style="font-size:14px;font-weight:600;color:#0f172a;"><?php echo e($item->siswa->nama ?? 'N/A'); ?></div>
                                <div style="font-size:12px;color:#64748b;"><?php echo e($item->buku->judul ?? 'Buku tidak tersedia'); ?></div>
                                <div style="font-size:11px;color:#94a3b8;margin-top:6px;"><?php echo e($item->status === 'dipinjam' ? 'Batas kembali: '.$item->batas_kembali : 'Tanggal kembali: '.$item->tanggal_kembali); ?></div>
                            </div>
                            <div style="text-align:right;">
                                <div style="font-size:14px;font-weight:700;color:#dc2626;">Rp <?php echo e(number_format($eventFine, 0, ',', '.')); ?></div>
                                <div style="font-size:11px;color:#64748b;margin-top:4px;"><?php echo e(ucfirst($item->status)); ?></div>
                            </div>
                        </div>
    ...
    <div class="quick-grid">
        <a href="<?php echo e(route('siswas.create')); ?>" class="quick-card">
        ...
        <a href="<?php echo e(route('kategoris.create')); ?>" class="quick-card">
        ...
        <a href="<?php echo e(route('bukus.create')); ?>" class="quick-card">
        ...
        <a href="<?php echo e(route('peminjamans.create')); ?>" class="quick-card">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Azzam-sp-XI-PPLG-1-TUGAS-MIGRATION\resources\views/dashboard.blade.php ENDPATH**/ ?>